...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    const alllProducts = document.getElementById("all-products")
    ...
    <div class="single-product card h-100">
        ...
        <div class="d-flex justify-content-between fw-bold">
            <p class="">Rate:<span class="text-primary"> 4.7</span></p>
            <p>Avg:<span class="text-primary"> 4.7</span></p>
        </div>
